...
class Program:
    ...
    def trasnlations(self):
        if self.vlanguage.get() == 1:
            ...
            self.lbl_intro.configure(text='introduce the result')
        ...
        if self.vlanguage.get() == 3:
            ...
            self.lbl_intro.configure(text='Introdizca el resultado')
        ...
        if self.vlanguage.get() == 2:
            ...
            self.lbl_intro.configure(text='enui la rizulto')
    ...
    def compare_voice_list_write_list(self):
        ...
        self.btn_close=Button(self.window, text='Close', command=self.close).grid(row=2, column=0)
